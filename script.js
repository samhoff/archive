...
if (new Date(1915, 09, 10).getTime() <= selectedDate && selectedDate <= new Date(1937, 04, 15).getTime()) {
...
} else if (new Date(1937, 04, 16).getTime() <= selectedDate && selectedDate <= new Date(1954, 10, 24).getTime()) {
