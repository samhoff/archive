...
var reeldata = [
  ...
  [01, 03, 0, 802702, 7, 1, 'zip'],
  [02, 04, 0, 801409, 20, 469, 'zip'],
  [03, 04, 90, 801408, 5, 1163, 'tar'],
  [04, 03, 0, 802605, 33, 2008, 'zip'],
  [05, 03, 0, 601009, 3, 2731, 'zip'],
  [06, 04, 0, 801407, 4, 3426, 'zip'],
  [07, 04, 0, 801406, 30, 4153, 'zip'],
  [08, 04, 90, 802708, 25, 4817, 'zip'],
  [09, 03, 0, 802609, 9, 5522, 'zip'],
  [10, 04, 0, 802709, 31, 6229, 'tar'],
  [11, 04, 0, 802703, 18, 6966, 'zip'],
  [12, 04, 0, 801406, 32, 7645, 'zip'],
  [13, 04, 90, 802701, 21, 8322, 'zip'],
  [14, 03, 0, 802705, 18, 9008, 'zip'],
  [15, 03, 0, 801408, 22, 9609, 'zip'],
  [16, 03, 0, 801408, 17, 10259, 'zip'],
  [17, 03, 0, 801406, 35, 10873, 'zip'],
  [18, 04, 0, 802604, 17, 11617, 'zip'],
  [19, 04, 90, 801406, 20, 12373, 'zip'],
  [20, 04, 90, 802605, 2, 12924, 'zip'],
  [21, 04, 270, 902605, 29, 13631, 'zip'],
  [22, 05, 0, 802606, 12, 14313, 'zip'],
  [23, 04, 270, 802703, 25, 14989, 'zip'],
  [24, 05, 0, 601406, 31, 15703, 'zip'],
  [25, 03, 0, 801407, 25, 16530, 'zip'],
  [26, 06, 0, 802704, 32, 17246, 'zip'],
  [27, 04, 0, 802706, 27, 17873, 'zip'],
  [28, 04, 0, 902205, 9, 18506, 'zip'],
  [29, 03, 0, 802703, 19, 18982, 'zip'],
  [30, 04, 270, 802608, 27, 19578, 'zip'],
  [31, 04, 0, 801403, 6, 20184, 'zip'],
  [32, 04, 0, 802700, 21, 20787, 'zip'],
  [33, 04, 0, 802700, 8, 21391, 'zip'],
  [34, 04, 90, 802706, 18, 22009, 'zip'],
  [35, 06, 0, 802609, 20, 22627, 'zip'],
  [36, 05, 0, 800100, 18, 23235, 'zip'],
  [37, 03, 0, 601408, 22, 23851, 'zip'],
  [38, 03, 0, 802608, 23, 24459, 'zip'],
  [39, 03, 0, 601408, 30, 25060, 'zip'],
  [40, 03, 0, 801407, 32, 25668, 'zip'],
  [41, 04, 0, 601408, 20, 26261, 'zip'],
  [42, 04, 0, 801407, 24, 26861, 'zip'],
  [43, 04, 0, 801409, 11, 27485, 'zip'],
  [44, 02, 0, 802607, 32, 28111, 'zip'],
  [45, 03, 0, 802706, 26, 28720, 'zip'],
  [46, 03, 0, 601403, 24, 29334, 'zip'],
  [47, 03, 0, 601409, 30, 29960, 'zip'],
  [48, 03, 0, 802606, 21, 30570, 'zip'],
  [49, 03, 0, 802707, 16, 31197, 'zip'],
  [50, 06, 0, 802700, 29, 31835, 'zip'],
  [51, 03, 0, 801409, 26, 32442, 'zip'],
  [52, 04, 0, 801309, 26, 33065, 'zip'],
  [53, 04, 0, 802705, 14, 33683, 'zip'],
  [54, 06, 0, 902205, 34, 34026, 'zip'],
  [55, 05, 0, 801409, 16, 34481, 'zip'],
  [56, 06, 0, 802609, 20, 34872, 'zip'],
  [57, 06, 0, 902606, 14, 35447, 'zip'],
  [58, 06, 0, 601406, 29, 35893, 'zip'],
  [59, 06, 0, 801406, 1, 36257, 'zip'],
  [60, 06, 0, 801403, 34, 36890, 'zip'],
  [61, 06, 0, 601409, 9, 37383, 'zip'],
  [62, 03, 0, 802605, 29, 38218, 'zip'],
  [63, 06, 0, 802709, 27, 38840, 'zip'],
  [64, 06, 0, 601408, 28, 39511, 'tar'],
  [65, 07, 0, 802703, 12, 40274, 'zip'],
  [66, 05, 0, 802605, 34, 40511, 'zip'],
  [67, 05, 0, 802608, 6, 41157, 'tar'],
  [68, 05, 0, 802708, 1, 41802, 'zip'],
  [69, 05, 0, 801406, 33, 42264, 'zip'],
  [70, 06, 0, 802704, 15, 42774, 'tar'],
  [71, 07, 270, 802704, 30, 43452, 'tar'],
  [72, 06, 0, 802608, 8, 44123, 'zip'],
  [73, 05, 0, 801408, 20, 44690, 'tar'],
  [74, 06, 0, 802706, 6, 45475, 'tar'],
  [75, 04, 0, 802702, 20, 46211, 'zip'],
  [76, 07, 0, 801407, 10, 46840, 'zip'],
  [77, 06, 0, 902706, 8, 47735, 'tar'],
  [78, 06, 0, 802706, 31, 48528, 'zip'],
  [79, 06, 0, 902205, 0, 49174, 'tar'],
  [80, 06, 0, 802704, 29, 50080, 'tar'],
  [81, 05, 0, 902604, 20, 50866, 'zip'],
  [82, 06, 0, 802700, 21, 51465, 'tar'],
  [83, 03, 0, 802608, 29, 52376, 'tar'],
  [84, 07, 0, 802607, 32, 53156, 'tar'],
  [85, 05, 0, 902205, 6, 53815, 'tar'],
  [86, 08, 0, 800301, 12, 54725, 'tar'],
  [87, 07, 0, 802702, 24, 55533, 'zip'],
  [88, 07, 0, 801406, 5, 56159, 'tar'],
  [89, 07, 0, 802705, 26, 56888, 'zip'],
  [90, 06, 0, 601409, 24, 57040, 'tar'],
  [91, 05, 0, 801407, 31, 57995, 'tar'],
  [92, 05, 0, 802707, 10, 58672, 'tar'],
  [93, 04, 0, 802605, 21, 59409, 'zip'],
  [94, 04, 0, 801409, 6, 59559, 'tar'],
  [95, 05, 0, 802205, 0, 60450, 'zip'],
  [96, 04, 0, 601409, 0, 61148, 'tar'],
  [97, 02, 0, 902700, 9, 61963, 'zip'],
  [98, 05, 0, 801403, 3, 62212, 'tar'],
  [99, 04, 0, 801409, 0, 63199, 'tar'],
  [100, 05, 0, 802707, 14, 63944, 'zip'],
  [101, 05, 0, 902605, 23, 64681, 'zip'],
  [102, 04, 0, 802605, 25, 64867, 'tar'],
  [103, 05, 0, 902704, 33, 65718, 'tar'],
  [104, 04, 0, 802205, 30, 66462, 'zip'],
  [105, 02, 0, 801406, 0, 66695, 'zip'],
  [106, 07, 0, 802707, 34, 67301, 'zip'],
  [107, 02, 0, 801407, 7, 67526, 'tar'],
  [108, 03, 0, 801407, 26, 68506, 'zip'],
  [109, 02, 0, 802205, 3, 69202, 'tar'],
  [110, 04, 0, 601407, 21, 70050, 'zip'],
  [111, 08, 0, 601408, 31, 70280, 'zip'],
  [112, 01, 0, 802606, 34, 70894, 'zip'],
  [113, 06, 0, 802609, 13, 71295, 'tar'],
  [114, 05, 0, 802607, 24, 72139, 'zip'],
  [115, 05, 0, 802707, 6, 72642, 'zip'],
  [116, 06, 0, 802606, 4, 73130, 'zip'],
  [117, 08, 0, 802607, 11, 73409, 'zip'],
  [118, 562, 0, 902701, 2, 73852, 'zip'],
  [119, 07, 0, 801408, 17, 74414, 'zip'],
  [120, 07, 0, 802605, 28, 74847, 'zip'],
  [121, 06, 0, 802607, 20, 75337, 'zip'],
  [122, 06, 0, 902607, 27, 75600, 'tar'],
  [123, 06, 0, 802705, 9, 76350, 'zip'],
  [124, 614, 0, 801409, 12, 76567, 'zip'],
  [125, 07, 0, 801409, 3, 77180, 'zip'],
  [126, 07, 0, 801406, 20, 77673, 'zip'],
  [127, 07, 0, 802604, 16, 78235, 'zip'],
  [128, 08, 0, 802609, 17, 78624, 'zip'],
  [129, 08, 0, 801408, 15, 79137, 'zip'],
  [130, 07, 0, 801406, 1, 79702, 'zip'],
  [131, 07, 0, 802704, 22, 79929, 'tar'],
  [132, 07, 0, 801409, 12, 80561, 'zip'],
  [133, 07, 0, 802604, 35, 81082, 'zip'],
  [134, 06, 0, 801409, 22, 81981, 'zip'],
  [135, 07, 0, 902606, 34, 82522, 'zip'],
  [136, 08, 0, 801409, 32, 82959, 'zip'],
  [137, 07, 0, 802707, 3, 83166, 'zip'],
  [138, 06, 0, 802608, 15, 83859, 'zip'],
  [139, 06, 0, 902701, 19, 84266, 'zip'],
  [140, 06, 0, 801006, 22, 84678, 'zip'],
  [141, 07, 0, 802705, 32, 85131, 'zip'],
  [142, 07, 0, 802705, 23, 85761, 'zip'],
  [143, 06, 0, 801403, 21, 86146, 'zip'],
  [144, 06, 0, 801407, 35, 86305, 'zip'],
  [145, 01, 0, 801403, 1, 86927, 'zip'],
  [146, 08, 0, 802605, 2, 87316, 'zip'],
  [147, 08, 0, 902703, 13, 88065, 'zip'],
  [148, 08, 0, 801406, 31, 88494, 'zip'],
  [149, 08, 0, 801407, 0, 88967, 'zip'],
  [150, 10, 0, 801408, 2, 89140, 'zip'],
  [151, 10, 0, 802704, 34, 89634, 'zip'],
  [152, 06, 0, 802701, 28, 90100, 'zip'],
  [153, 07, 0, 801409, 31, 90880, 'zip'],
  [154, 07, 0, 801407, 5, 91311, 'zip'],
  [155, 06, 0, 802609, 9, 91732, 'zip'],
  [156, 06, 0, 801408, 17, 91909, 'zip'],
  [157, 07, 0, 802706, 14, 92479, 'zip'],
  [158, 06, 0, 902706, 34, 92906, 'zip'],
  [159, 05, 0, 802704, 9, 93345, 'zip'],
  [160, 08, 0, 802608, 15, 93716, 'zip'],
  [161, 08, 0, 801406, 35, 94387, 'zip'],
  [162, 06, 0, 801408, 16, 94630, 'zip'],
  [163, 07, 0, 802700, 18, 94839, 'zip'],
  [164, 07, 0, 802702, 4, 95532, 'zip'],
  [165, 06, 0, 902205, 21, 95834, 'zip'],
  [166, 06, 0, 802705, 13, 96133, 'zip'],
  [167, 06, 0, 601406, 27, 96654, 'tar'],
  [168, 06, 0, 802205, 26, 97579, 'zip'],
  [169, 06, 0, 902700, 17, 97756, 'tar'],
  [170, 06, 0, 601405, 21, 98828, 'zip'],
  [171, 06, 0, 802700, 7, 99649, 'tar'],
  [172, 06, 0, 801408, 16, 100724, 'zip'],
  [173, 06, 0, 802606, 3, 100919, 'zip'],
  [174, 06, 0, 802705, 16, 101500, 'zip'],
  [175, 06, 0, 801407, 18, 102158, 'zip'],
  [176, 06, 0, 802607, 24, 102674, 'zip'],
  [177, 05, 0, 801407, 12, 103106, 'zip'],
  [178, 06, 0, 902607, 12, 104123, 'zip'],
  [179, 05, 0, 801407, 13, 104290, 'tar'],
  [180, 05, 0, 802604, 20, 105344, 'tar'],
  [181, 07, 0, 802704, 9, 106113, 'tar'],
  [182, 06, 0, 802704, 19, 107006, 'zip'],
  [183, 07, 0, 802707, 24, 107167, 'zip'],
  [184, 05, 0, 600202, 25, 107805, 'zip'],
  [185, 07, 0, 802205, 2, 108315, 'tar'],
  [186, 06, 0, 802605, 26, 109183, 'tar'],
  [187, 06, 0, 802702, 10, 110175, 'zip'],
  [188, 06, 0, 802604, 9, 110370, 'zip'],
  [189, 07, 0, 801407, 6, 110891, 'zip'],
  [190, 07, 0, 802704, 10, 111689, 'zip'],
  [191, 07, 0, 800202, 25, 112565, 'zip'],
  [192, 07, 0, 800200, 12, 112748, 'zip'],
  [193, 07, 0, 802701, 4, 113305, 'zip'],
  [194, 07, 0, 802606, 33, 113691, 'zip'],
  [195, 07, 90, 801006, 24, 114431, 'zip'],
  [196, 06, 0, 802605, 24, 114801, 'zip'],
  [197, 06, 0, 801406, 3, 115404, 'zip'],
  [198, 06, 0, 801407, 17, 115611, 'zip'],
  [199, 06, 0, 601408, 14, 116153, 'zip'],
]
...
function determinelosax() {
  if (reel == 184 || reel == 191 || reel == 192) {
    //Reels 184, 191 and 192 have an extra "x" in their URLs
    losax = 'x'
  } else {
    losax = ''
  }
...
function loadnewpage() {
  ...
  if (
    ...
    Number(dbpageid) > 0 &&
    Number(dbpageid) <= 116752
  ) {
    //Max dbpageid for archive.org is 116,752.
    var dataid = dbpageid
    if (dataid >= 1 && dataid < 469) {
      reel = 01
    }
    if (dataid >= 469 && dataid < 1163) {
      reel = 02
    }
    if (dataid >= 1163 && dataid < 2008) {
      reel = 03
    }
    if (dataid >= 2008 && dataid < 2731) {
      reel = 04
    }
    if (dataid >= 2731 && dataid < 3426) {
      reel = 05
    }
    if (dataid >= 3426 && dataid < 4153) {
      reel = 06
    }
    if (dataid >= 4153 && dataid < 4817) {
      reel = 07
    }
    if (dataid >= 4817 && dataid < 5522) {
      reel = 08
    }
    if (dataid >= 5522 && dataid < 6229) {
      reel = 09
    }
    if (dataid >= 6229 && dataid < 6966) {
      reel = 10
    }
    if (dataid >= 6966 && dataid < 7645) {
      reel = 11
    }
    if (dataid >= 7645 && dataid < 8322) {
      reel = 12
    }
    if (dataid >= 8322 && dataid < 9008) {
      reel = 13
    }
    if (dataid >= 9008 && dataid < 9609) {
      reel = 14
    }
    if (dataid >= 9609 && dataid < 10259) {
      reel = 15
    }
    if (dataid >= 10259 && dataid < 10873) {
      reel = 16
    }
    if (dataid >= 10873 && dataid < 11617) {
      reel = 17
    }
    if (dataid >= 11617 && dataid < 12373) {
      reel = 18
    }
    if (dataid >= 12373 && dataid < 12924) {
      reel = 19
    }
    if (dataid >= 12924 && dataid < 13631) {
      reel = 20
    }
    if (dataid >= 13631 && dataid < 14313) {
      reel = 21
    }
    if (dataid >= 14313 && dataid < 14989) {
      reel = 22
    }
    if (dataid >= 14989 && dataid < 15703) {
      reel = 23
    }
    if (dataid >= 15703 && dataid < 16530) {
      reel = 24
    }
    if (dataid >= 16530 && dataid < 17246) {
      reel = 25
    }
    if (dataid >= 17246 && dataid < 17873) {
      reel = 26
    }
    if (dataid >= 17873 && dataid < 18506) {
      reel = 27
    }
    if (dataid >= 18506 && dataid < 18982) {
      reel = 28
    }
    if (dataid >= 18982 && dataid < 19578) {
      reel = 29
    }
    if (dataid >= 19578 && dataid < 20184) {
      reel = 30
    }
    if (dataid >= 20184 && dataid < 20787) {
      reel = 31
    }
    if (dataid >= 20787 && dataid < 21391) {
      reel = 32
    }
    if (dataid >= 21391 && dataid < 22009) {
      reel = 33
    }
    if (dataid >= 22009 && dataid < 22627) {
      reel = 34
    }
    if (dataid >= 22627 && dataid < 23235) {
      reel = 35
    }
    if (dataid >= 23235 && dataid < 23851) {
      reel = 36
    }
    if (dataid >= 23851 && dataid < 24459) {
      reel = 37
    }
    if (dataid >= 24459 && dataid < 25060) {
      reel = 38
    }
    if (dataid >= 25060 && dataid < 25668) {
      reel = 39
    }
    if (dataid >= 25668 && dataid < 26261) {
      reel = 40
    }
    if (dataid >= 26261 && dataid < 26861) {
      reel = 41
    }
    if (dataid >= 26861 && dataid < 27485) {
      reel = 42
    }
    if (dataid >= 27485 && dataid < 28111) {
      reel = 43
    }
    if (dataid >= 28111 && dataid < 28720) {
      reel = 44
    }
    if (dataid >= 28720 && dataid < 29334) {
      reel = 45
    }
    if (dataid >= 29334 && dataid < 29960) {
      reel = 46
    }
    if (dataid >= 29960 && dataid < 30570) {
      reel = 47
    }
    if (dataid >= 30570 && dataid < 31197) {
      reel = 48
    }
    if (dataid >= 31197 && dataid < 31835) {
      reel = 49
    }
    if (dataid >= 31835 && dataid < 32442) {
      reel = 50
    }
    if (dataid >= 32442 && dataid < 33065) {
      reel = 51
    }
    if (dataid >= 33065 && dataid < 33683) {
      reel = 52
    }
    if (dataid >= 33683 && dataid < 34026) {
      reel = 53
    }
    if (dataid >= 34026 && dataid < 34481) {
      reel = 54
    }
    if (dataid >= 34481 && dataid < 34872) {
      reel = 55
    }
    if (dataid >= 34872 && dataid < 35447) {
      reel = 56
    }
    if (dataid >= 35447 && dataid < 35893) {
      reel = 57
    }
    if (dataid >= 35893 && dataid < 36257) {
      reel = 58
    }
    if (dataid >= 36257 && dataid < 36890) {
      reel = 59
    }
    if (dataid >= 36890 && dataid < 37383) {
      reel = 60
    }
    if (dataid >= 37383 && dataid < 38218) {
      reel = 61
    }
    if (dataid >= 38218 && dataid < 38840) {
      reel = 62
    }
    if (dataid >= 38840 && dataid < 39511) {
      reel = 63
    }
    if (dataid >= 39511 && dataid < 40274) {
      reel = 64
    }
    if (dataid >= 40274 && dataid < 40511) {
      reel = 65
    }
    if (dataid >= 40511 && dataid < 41157) {
      reel = 66
    }
    if (dataid >= 41157 && dataid < 41802) {
      reel = 67
    }
    if (dataid >= 41802 && dataid < 42264) {
      reel = 68
    }
    if (dataid >= 42264 && dataid < 42774) {
      reel = 69
    }
    if (dataid >= 42774 && dataid < 43452) {
      reel = 70
    }
    if (dataid >= 43452 && dataid < 44123) {
      reel = 71
    }
    if (dataid >= 44123 && dataid < 44690) {
      reel = 72
    }
    if (dataid >= 44690 && dataid < 45475) {
      reel = 73
    }
    if (dataid >= 45475 && dataid < 46211) {
      reel = 74
    }
    if (dataid >= 46211 && dataid < 46840) {
      reel = 75
    }
    if (dataid >= 46840 && dataid < 47735) {
      reel = 76
    }
    if (dataid >= 47735 && dataid < 48528) {
      reel = 77
    }
    if (dataid >= 48528 && dataid < 49174) {
      reel = 78
    }
    if (dataid >= 49174 && dataid < 50080) {
      reel = 79
    }
    if (dataid >= 50080 && dataid < 50866) {
      reel = 80
    }
    if (dataid >= 50866 && dataid < 51465) {
      reel = 81
    }
    if (dataid >= 51465 && dataid < 52376) {
      reel = 82
    }
    if (dataid >= 52376 && dataid < 53156) {
      reel = 83
    }
    if (dataid >= 53156 && dataid < 53815) {
      reel = 84
    }
    if (dataid >= 53815 && dataid < 54725) {
      reel = 85
    }
    if (dataid >= 54725 && dataid < 55533) {
      reel = 86
    }
    if (dataid >= 55533 && dataid < 56159) {
      reel = 87
    }
    if (dataid >= 56159 && dataid < 56888) {
      reel = 88
    }
    if (dataid >= 56888 && dataid < 57040) {
      reel = 89
    }
    if (dataid >= 57040 && dataid < 57995) {
      reel = 90
    }
    if (dataid >= 57995 && dataid < 58672) {
      reel = 91
    }
    if (dataid >= 58672 && dataid < 59409) {
      reel = 92
    }
    if (dataid >= 59409 && dataid < 59559) {
      reel = 93
    }
    if (dataid >= 59559 && dataid < 60450) {
      reel = 94
    }
    if (dataid >= 60450 && dataid < 61148) {
      reel = 95
    }
    if (dataid >= 61148 && dataid < 61963) {
      reel = 96
    }
    if (dataid >= 61963 && dataid < 62212) {
      reel = 97
    }
    if (dataid >= 62212 && dataid < 63199) {
      reel = 98
    }
    if (dataid >= 63199 && dataid < 63944) {
      reel = 99
    }
    if (dataid >= 63944 && dataid < 64681) {
      reel = 100
    }
    if (dataid >= 64681 && dataid < 64867) {
      reel = 101
    }
    if (dataid >= 64867 && dataid < 65718) {
      reel = 102
    }
    if (dataid >= 65718 && dataid < 66462) {
      reel = 103
    }
    if (dataid >= 66462 && dataid < 66695) {
      reel = 104
    }
    if (dataid >= 66695 && dataid < 67301) {
      reel = 105
    }
    if (dataid >= 67301 && dataid < 67526) {
      reel = 106
    }
    if (dataid >= 67526 && dataid < 68506) {
      reel = 107
    }
    if (dataid >= 68506 && dataid < 69202) {
      reel = 108
    }
    if (dataid >= 69202 && dataid < 70050) {
      reel = 109
    }
    if (dataid >= 70050 && dataid < 70280) {
      reel = 110
    }
    if (dataid >= 70280 && dataid < 70894) {
      reel = 111
    }
    if (dataid >= 70894 && dataid < 71295) {
      reel = 112
    }
    if (dataid >= 71295 && dataid < 72139) {
      reel = 113
    }
    if (dataid >= 72139 && dataid < 72642) {
      reel = 114
    }
    if (dataid >= 72642 && dataid < 73130) {
      reel = 115
    }
    if (dataid >= 73130 && dataid < 73409) {
      reel = 116
    }
    if (dataid >= 73409 && dataid < 73852) {
      reel = 117
    }
    if (dataid >= 73852 && dataid < 74414) {
      reel = 118
    }
    if (dataid >= 74414 && dataid < 74847) {
      reel = 119
    }
    if (dataid >= 74847 && dataid < 75337) {
      reel = 120
    }
    if (dataid >= 75337 && dataid < 75600) {
      reel = 121
    }
    if (dataid >= 75600 && dataid < 76350) {
      reel = 122
    }
    if (dataid >= 76350 && dataid < 76567) {
      reel = 123
    }
    if (dataid >= 76567 && dataid < 77180) {
      reel = 124
    }
    if (dataid >= 77180 && dataid < 77673) {
      reel = 125
    }
    if (dataid >= 77673 && dataid < 78235) {
      reel = 126
    }
    if (dataid >= 78235 && dataid < 78624) {
      reel = 127
    }
    if (dataid >= 78624 && dataid < 79137) {
      reel = 128
    }
    if (dataid >= 79137 && dataid < 79702) {
      reel = 129
    }
    if (dataid >= 79702 && dataid < 79929) {
      reel = 130
    }
    if (dataid >= 79929 && dataid < 80561) {
      reel = 131
    }
    if (dataid >= 80561 && dataid < 81082) {
      reel = 132
    }
    if (dataid >= 81082 && dataid < 81981) {
      reel = 133
    }
    if (dataid >= 81981 && dataid < 82522) {
      reel = 134
    }
    if (dataid >= 82522 && dataid < 82959) {
      reel = 135
    }
    if (dataid >= 82959 && dataid < 83166) {
      reel = 136
    }
    if (dataid >= 83166 && dataid < 83859) {
      reel = 137
    }
    if (dataid >= 83859 && dataid < 84266) {
      reel = 138
    }
    if (dataid >= 84266 && dataid < 84678) {
      reel = 139
    }
    if (dataid >= 84678 && dataid < 85131) {
      reel = 140
    }
    if (dataid >= 85131 && dataid < 85761) {
      reel = 141
    }
    if (dataid >= 85761 && dataid < 86146) {
      reel = 142
    }
    if (dataid >= 86146 && dataid < 86305) {
      reel = 143
    }
    if (dataid >= 86305 && dataid < 86927) {
      reel = 144
    }
    if (dataid >= 86927 && dataid < 87316) {
      reel = 145
    }
    if (dataid >= 87316 && dataid < 88065) {
      reel = 146
    }
    if (dataid >= 88065 && dataid < 88494) {
      reel = 147
    }
    if (dataid >= 88494 && dataid < 88967) {
      reel = 148
    }
    if (dataid >= 88967 && dataid < 89140) {
      reel = 149
    }
    if (dataid >= 89140 && dataid < 89634) {
      reel = 150
    }
    if (dataid >= 89634 && dataid < 90100) {
      reel = 151
    }
    if (dataid >= 90100 && dataid < 90880) {
      reel = 152
    }
    if (dataid >= 90880 && dataid < 91311) {
      reel = 153
    }
    if (dataid >= 91311 && dataid < 91732) {
      reel = 154
    }
    if (dataid >= 91732 && dataid < 91909) {
      reel = 155
    }
    if (dataid >= 91909 && dataid < 92479) {
      reel = 156
    }
    if (dataid >= 92479 && dataid < 92906) {
      reel = 157
    }
    if (dataid >= 92906 && dataid < 93345) {
      reel = 158
    }
    if (dataid >= 93345 && dataid < 93716) {
      reel = 159
    }
    if (dataid >= 93716 && dataid < 94387) {
      reel = 160
    }
    if (dataid >= 94387 && dataid < 94630) {
      reel = 161
    }
    if (dataid >= 94630 && dataid < 94839) {
      reel = 162
    }
    if (dataid >= 94839 && dataid < 95532) {
      reel = 163
    }
    if (dataid >= 95532 && dataid < 95834) {
      reel = 164
    }
    if (dataid >= 95834 && dataid < 96133) {
      reel = 165
    }
    if (dataid >= 96133 && dataid < 96654) {
      reel = 166
    }
    if (dataid >= 96654 && dataid < 97579) {
      reel = 167
    }
    if (dataid >= 97579 && dataid < 97756) {
      reel = 168
    }
    if (dataid >= 97756 && dataid < 98828) {
      reel = 169
    }
    if (dataid >= 98828 && dataid < 99649) {
      reel = 170
    }
    if (dataid >= 99649 && dataid < 100724) {
      reel = 171
    }
    if (dataid >= 100724 && dataid < 100919) {
      reel = 172
    }
    if (dataid >= 100919 && dataid < 101500) {
      reel = 173
    }
    if (dataid >= 101500 && dataid < 102158) {
      reel = 174
    }
    if (dataid >= 102158 && dataid < 102674) {
      reel = 175
    }
    if (dataid >= 102674 && dataid < 103106) {
      reel = 176
    }
    if (dataid >= 103106 && dataid < 104123) {
      reel = 177
    }
    if (dataid >= 104123 && dataid < 104290) {
      reel = 178
    }
    if (dataid >= 104290 && dataid < 105344) {
      reel = 179
    }
    if (dataid >= 105344 && dataid < 106113) {
      reel = 180
    }
    if (dataid >= 106113 && dataid < 107006) {
      reel = 181
    }
    if (dataid >= 107006 && dataid < 107167) {
      reel = 182
    }
    if (dataid >= 107167 && dataid < 107805) {
      reel = 183
    }
    if (dataid >= 107805 && dataid < 108315) {
      reel = 184
    }
    if (dataid >= 108315 && dataid < 109183) {
      reel = 185
    }
    if (dataid >= 109183 && dataid < 110175) {
      reel = 186
    }
    if (dataid >= 110175 && dataid < 110370) {
      reel = 187
    }
    if (dataid >= 110370 && dataid < 110891) {
      reel = 188
    }
    if (dataid >= 110891 && dataid < 111689) {
      reel = 189
    }
    if (dataid >= 111689 && dataid < 112565) {
      reel = 190
    }
    if (dataid >= 112565 && dataid < 112748) {
      reel = 191
    }
    if (dataid >= 112748 && dataid < 113305) {
      reel = 192
    }
    if (dataid >= 113305 && dataid < 113691) {
      reel = 193
    }
    if (dataid >= 113691 && dataid < 114431) {
      reel = 194
    }
    if (dataid >= 114431 && dataid < 114801) {
      reel = 195
    }
    if (dataid >= 114801 && dataid < 115404) {
      reel = 196
    }
    if (dataid >= 115404 && dataid < 115611) {
      reel = 197
    }
    if (dataid >= 115611 && dataid < 116153) {
      reel = 198
    }
    if (dataid >= 116153 && dataid <= 116752) {
      reel = 199
    } //Max dbpageid before google drive is 116,752.
    if (reel < 118 || reel > 124 || 118 < reel < 124) {
      reelpage =
        parseInt(dataid) +
        parseInt(reeldata[reel][1]) -
        parseInt(reeldata[reel][5])
    }
    if (reel == 118 || reel == 124) {
      //For reels 118 and 124, the reels are organized backwards.
      reelpage =
        -parseInt(dataid) +
        parseInt(reeldata[reel][1]) +
        parseInt(reeldata[reel][5])
    ...
    if (0 <= preroundrotate <= 270) {
      rotate = preroundrotate
    }
    if (preroundrotate < 0) {
      customrotate = customrotate + 360
      preroundrotate = customrotate + parseInt(reeldata[reel][2])
      rotate = preroundrotate
    }
    if (preroundrotate >= 360) {
      customrotate = customrotate - 360
      preroundrotate = customrotate + parseInt(reeldata[reel][2])
      rotate = preroundrotate
    }
